...
class home(ctk.CTkFrame):
    ...
    def show_home_menu(self):
        # Destroy the calendar menu and show the home menu elements again
        self.intervalTimerContainer.destroy()

        self.packItems()
        self.update()
        self.createButtons()
        # Pack or place other elements back
    ...
    def createButtons(self):
        self.buttonContainer = ctk.CTkFrame(self.master)
        ...
        self.fitnessButton.place(x=-40, y=320, in_= self.buttonContainer, anchor = "center")

        self.piHoleButton = ctk.CTkButton(self.master, text="Pi-Hole", height = 100, width = 120, font = ("Roboto", 29))
        self.piHoleButton.place(x=250, y=320, in_= self.buttonContainer, anchor = "center")
        ...
        self.prayerButton.place(x=200, y=470, in_= self.buttonContainer, anchor = "center")
        ...
        self.deviceButton.place(x=450, y=470, in_= self.buttonContainer, anchor = "center")

        self.intervalButton = ctk.CTkButton(self.master, text="Interval Timer", height = 60, width = 300, font = ("Roboto", 29), command=lambda: self.openInterval())
        self.intervalButton.place(x=235, y=620, in_= self.buttonContainer, anchor = "center")
