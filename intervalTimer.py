...
############################################################################################################
    ...
    def packButtons(self):
        self.container = ctk.CTkFrame(self.master, height = 700, width = 650)
        self.container.pack(side='top')
        self.titleLabel = ctk.CTkLabel(self.master, text = "INTERVAL TIMER", font = ("Roboto", 36))
        self.titleLabel.pack(side='top', pady=15, in_= self.container, anchor = "center")

        self.timer1 = ctk.CTkButton(self.master, text = "1:00", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(0, "1:00"))
        self.timer1.place(x = -130, y = 150, in_= self.container, anchor = "center")
        self.timer2 = ctk.CTkButton(self.master, text = "2:00", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(0, "2:00"))
        self.timer2.place(x = 50, y = 150, in_= self.container, anchor = "center")
        self.timer3 = ctk.CTkButton(self.master, text = "3:00", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(0, "3:00"))
        self.timer3.place(x = 230, y = 150, in_= self.container, anchor = "center")
        self.timer4 = ctk.CTkButton(self.master, text = "Custom", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.enterCustom("timer"))
        self.timer4.place(x = 410, y = 150, in_= self.container, anchor = "center")

        self.roundsLabel = ctk.CTkLabel(self.master, text = "ROUNDS", font = ("Roboto", 41))
        self.roundsLabel.place(x = 125, y = 260, in_= self.container, anchor = "center")
        self.rounds1 = ctk.CTkButton(self.master, text = "1", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(1, 1))
        self.rounds1.place(x = -130, y = 370, in_= self.container, anchor = "center")
        self.rounds2 = ctk.CTkButton(self.master, text = "3", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(1, 3))
        self.rounds2.place(x = 50, y = 370, in_= self.container, anchor = "center")
        self.rounds3 = ctk.CTkButton(self.master, text = "5", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(1, 5))
        self.rounds3.place(x = 230, y = 370, in_= self.container, anchor = "center")
        self.rounds4 = ctk.CTkButton(self.master, text = "Custom", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.enterCustom("rounds"))
        self.rounds4.place(x = 410, y = 370, in_= self.container, anchor = "center")

        self.restLabel = ctk.CTkLabel(self.master, text = "REST PERIODS", font = ("Roboto", 41))
        self.restLabel.place(x = 130 , y = 480, in_= self.container, anchor = "center")
        self.rest1 = ctk.CTkButton(self.master, text = "00:15", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(2, "00:15"))
        self.rest1.place(x = -130, y = 590, in_= self.container, anchor = "center")
        self.rest2 = ctk.CTkButton(self.master, text = "00:30", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(2, "00:30"))
        self.rest2.place(x = 50, y = 590, in_= self.container, anchor = "center")
        self.rest3 = ctk.CTkButton(self.master, text = "1:00", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.assignValue(2, "1:00"))
        self.rest3.place(x = 230, y = 590, in_= self.container, anchor = "center")
        self.rest4 = ctk.CTkButton(self.master, text = "Custom", height = 120, width = 140, font = ("Roboto", 36), command=lambda: self.enterCustom("rest"))
        self.rest4.place(x = 410, y = 590, in_= self.container, anchor = "center")

        self.startButton = ctk.CTkButton(self.master, text = "Start", height = 120, width = 160, font = ("Roboto", 36), command=lambda: self.startTimer())
        self.startButton.place(x = 125, y = 760, in_= self.container, anchor = "center")
